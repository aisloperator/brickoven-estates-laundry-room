(function () {
  ...
  var rightPageMat = new THREE.MeshBasicMaterial({
    map: createPosterTexture('#f0e6c8', '#cbb98f', [
      { text: 'You can also leave free', y: 54, color: '#2a2216', font: PAGE_FONT_SMALL },
      { text: 'small, non-clothing', y: 88, color: '#2a2216', font: PAGE_FONT_SMALL },
      { text: 'items on the corner of', y: 122, color: '#2a2216', font: PAGE_FONT_SMALL },
      { text: 'the countertop next to', y: 156, color: '#2a2216', font: PAGE_FONT_SMALL },
      { text: 'the bookshelves, if', y: 190, color: '#2a2216', font: PAGE_FONT_SMALL },
      { text: "there's room.", y: 224, color: '#2a2216', font: PAGE_FONT_SMALL },
      { text: "And it's a local", y: 274, color: '#2a2216', font: PAGE_FONT_SMALL },
      { text: 'tradition to put usable', y: 308, color: '#2a2216', font: PAGE_FONT_SMALL },
      { text: 'unwanted household', y: 342, color: '#2a2216', font: PAGE_FONT_SMALL },
      { text: 'items on the curb, for', y: 376, color: '#2a2216', font: PAGE_FONT_SMALL },
      { text: 'a passerby to reuse.', y: 410, color: '#2a2216', font: PAGE_FONT_SMALL },
      { text: 'Clothing is best', y: 460, color: '#2a2216', font: PAGE_FONT_SMALL },
      { text: 'donated.', y: 494, color: '#2a2216', font: PAGE_FONT_SMALL }
    ])
  });
